            ...
            <form method="post" method="get" action="LoginServlet">
                <table>
                    <tr>
                        <td>Email</td>
                        <td>
                            <input type="text" placeholder="<%=(emailErr != null ? emailErr : "Enter email")%>"
                                name="Email"></td>
                    </tr>
                    <tr>
                        <td>Password</td>
                        <td>
                            <input type="password" placeholder="<%=(passErr != null ? passErr : "Enter password")%>"
                                name="Password"></td>
                    </tr>
                </table>
